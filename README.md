...
```javascript
tryRequire = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/utils-try-require@v0.1.1-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/utils-try-require@v0.1.1-umd/browser.js"></script>
```
